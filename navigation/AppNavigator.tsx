  ...
  return (
    ...
    >
      <Tab.Screen
        ...
        options={{ tabBarLabel: 'Dashboard', tabBarIcon: ({ focused, size }) => <TabIcon name="home" focused={focused} size={size} /> }}
      />
      <Tab.Screen
        name="Citas"
        component={CitasStackNavigator}
        options={{ tabBarLabel: 'Citas', tabBarIcon: ({ focused, size }) => <TabIcon name="calendar" focused={focused} size={size} /> }}
      />
      <Tab.Screen
        name="Pacientes"
        component={PacientesStackNavigator}
        options={{ tabBarLabel: 'Pacientes', tabBarIcon: ({ focused, size }) => <TabIcon name="people" focused={focused} size={size} /> }}
      />
      <Tab.Screen
        name="Familias"
        component={FamiliasScreen}
        options={{ tabBarLabel: 'Familias', tabBarIcon: ({ focused, size }) => <TabIcon name="heart" focused={focused} size={size} /> }}
      />
      <Tab.Screen
        name="Clínicas"
        component={ClinicasScreen}
        options={{ tabBarLabel: 'Clínicas', tabBarIcon: ({ focused, size }) => <TabIcon name="business" focused={focused} size={size} /> }}
      />
    </Tab.Navigator>
  );
}
...
const styles = StyleSheet.create({
  tabBar: { backgroundColor: TAB_BG, borderTopWidth: 0, elevation: 20, shadowColor: '#000', shadowOffset: { width: 0, height: -4 }, shadowOpacity: 0.08, shadowRadius: 12, height: 64, paddingBottom: 8, paddingTop: 6 },
  tabBarBackground: { flex: 1, backgroundColor: TAB_BG, borderTopLeftRadius: 20, borderTopRightRadius: 20 },
